...
namespace Attendence_System_Sharp_
{
    public partial class Mdi_Parent : Form
    {
        ...
        private void Mdi_Parent_Load(object sender, EventArgs e)
        {
            ...
            Controls.OfType<MdiClient>().FirstOrDefault().BackgroundImage = Image.FromFile(@"C:\Users\Dell Inspiron\Documents\Visual Studio 2013\Projects\Attendence_System(Sharp)\Attendence_System(Sharp)\Images\05.jpg");
